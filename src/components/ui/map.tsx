...
import { setWorkerUrl, type PopupOptions, type MarkerOptions } from "maplibre-gl";
...
import { FAST_MAP_STYLES } from "@/lib/mapStyle";
import { cn } from "@/lib/utils";

// MapLibre v6: Vite must bundle the worker (shared chunk) — do not rely on optimizeDeps copy.
setWorkerUrl(maplibreWorkerUrl);

const defaultStyles = {
  dark: FAST_MAP_STYLES.dark,
  light: FAST_MAP_STYLES.light,
};
...
>({
      ...
      mergeHoverPaint(
        {
          ...
          ...(fillPaint === false ? undefined : fillPaint),
        },
        fillHoverPaint,
      ),
  ...
  const mergedLinePaint = useMemo(
    () => ({
      ...
      "line-width": 0.5,
      ...(linePaint === false ? undefined : linePaint),
    }),
